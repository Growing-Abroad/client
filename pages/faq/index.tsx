...
export const GeneralFaqMockUp = [
  {
    ...
    content: (
      <p style={{ marginBottom: 0 }}>
        We want to help you get your dream job in Germany or Europe. That's why
        we have different{" "}
        <Link style={{ color: "#0073cf" }} href="/coaching">
          coaching packages
        </Link>{" "}
        available to guide you along the way. We also have an{" "}
        <Link style={{ color: "#0073cf" }} href="/online-course">
          online course
        </Link>{" "}
        that will lead you through every step you need to take to land your
        dream job in Germany or Europe.
      </p>
    ),
  },
  {
    ...
    content: (
      <>
        Not everyone can easily find a job in Germany. There are certain
        requirements you need to meet: <br />
        <br />
        <Ul>
          <li>
            Very good knowledge of the English language (German is not
            mandatory, but it increases your chances).
          </li>
          <li>Completed vocational training or a higher education degree.</li>
          <li>
  ...
  },
  {
    ...
    content: (
      <>
        The first thing you need is a job offer from a German company. Without a
        job offer, you can't get a work visa. So, the first step is to find a
        job offer. Here are some steps to get a job offer from a German company:{" "}
        <br />
        <br />
        <Ul>
        ...
        <p style={{ marginBottom: 0 }}>
          ...
          just for you. In this course, we will guide you through each step to
...
export default function FAQ() {
  ...
  return (
    <Wrapper>
      <SEO
        description="Growing abroad helps skilled foreigners to realize their dream to live and work in Germany or Europe. Learn more about our services and contact us for more "
        title="Faq | Growing Abroad"
        url="https://growingabroad.de/faq"
      />
      <FaqHeroSection />
      <PageBodyLayout
        id="page-faq"
