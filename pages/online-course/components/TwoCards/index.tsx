...
export function TwoCards() {
  return (
    <S.Container>
      <TwoColorTitle text1="Who is this " styles={{fontSize:'60px'}} text2="Online Course for?" />
      <S.ContentTwoCards>
        <S.TwoCardsWrapper>
          <Image src={onlineCourse} alt="" width={454} height={265} style={{borderRadius:'10px'}} />
          <h3>
            <svg
              width="64"
              height="64"
        ...
        <S.TwoCardsWrapper className="right-card">
          <Image src={onlineCourse} alt="" width={454} height={264} />
          <h3>
            {' '}
            <svg
              width="64"
